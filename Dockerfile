...
RUN echo "lightning" \
    && pip --no-cache-dir install lightning

RUN echo "mlflow" \
    && pip --no-cache-dir install mlflow

RUN echo "tqdm" \
    && pip --no-cache-dir install tqdm

RUN echo "huggingface_hub" \
    && pip --no-cache-dir install huggingface_hub

RUN echo "accelerate" \
    && pip --no-cache-dir install accelerate
