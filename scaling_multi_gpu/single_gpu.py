...
def get_dataloader(trainset, batch_size):
    return DataLoader(trainset, batch_size=batch_size, shuffle=True, num_workers=7)
...
def train():
    ...
    with torch.profiler.profile(
        ...
        for epoch in range(6):
            ...
            writer.add_scalar('epoch time', time.time() - start_epoch, epoch)
