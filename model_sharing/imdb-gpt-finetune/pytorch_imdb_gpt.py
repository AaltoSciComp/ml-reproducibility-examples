...
# https://github.com/csc-training/intro-to-dl/blob/master/day2/pytorch_imdb_gpt.py
...
def preprocess_data(train_dataset, test_dataset,
    ...
    # We split a small amount of training data as "validation" set
...
if __name__ == "__main__":
    ...
    # TensorBoardCallback reads TENSORBOARD_LOGGING_DIR, not TrainingArguments.logging_dir.
    os.environ["TENSORBOARD_LOGGING_DIR"] = logging_dir

    output_dir = os.path.join(datapath, "gpt-imdb-model")
    training_args = TrainingArguments(
